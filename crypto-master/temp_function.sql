CREATE OR REPLACE FUNCTION effectuer_vente(p_idportefeuillefille integer, p_nbr_a_vendre integer)
RETURNS TABLE (
...
BEGIN
    ...
    (id_portefeuille, nom_crypto, type_action, nbrcrypto, prix, prixtotal, montant_commission, taux_commission, prix_total_avec_commission, date_action)
    SELECT 
        p.id, 
        c.nom_crypto, 
        a.type_action, 
